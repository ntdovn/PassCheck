    ...
    <div className="max-w-4xl mx-auto animate-fade-in">
      ...
      <div className="card mb-8">
        <div className="grid md:grid-cols-3 gap-4">
          ...
          >
            <Hash className="h-8 w-8 mx-auto mb-2 text-primary-600" />
            <div className="font-semibold text-gray-900">Ngẫu nhiên</div>
            <div className="text-sm text-gray-600">Mật khẩu hoàn toàn random</div>
          </button>
          <button
          ...
          >
            <Sparkles className="h-8 w-8 mx-auto mb-2 text-primary-600" />
            <div className="font-semibold text-gray-900">Dễ nhớ</div>
            <div className="text-sm text-gray-600">Từ các từ khóa của bạn</div>
          </button>
          <button
          ...
          >
            <Key className="h-8 w-8 mx-auto mb-2 text-primary-600" />
            <div className="font-semibold text-gray-900">Passphrase</div>
            <div className="text-sm text-gray-600">Chuỗi từ ngẫu nhiên</div>
          </button>
        </div>
      </div>
      ...
      {/* Options */}
      <div className="card mb-8">
        <h3 className="text-xl font-bold text-gray-900 mb-4">Tùy chọn</h3>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <label className="flex items-center space-x-2 cursor-pointer md:col-span-2">
                <input
                  ...
                  className="w-4 h-4 text-primary-600"
                />
                <span>Loại bỏ ký tự dễ nhầm (il1Lo0O)</span>
              </label>
            </div>
          </div>
        )}
            ...
            <div className="space-y-2">
              <label className="flex items-center space-x-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 text-primary-600"
                />
                <span>Viết hoa chữ cái đầu</span>
              </label>
              <label className="flex items-center space-x-2 cursor-pointer">
                <input
                  type="checkbox"
      ...
      {generatedPassword && (
        <div className="card animate-slide-up">
          <h3 className="text-xl font-bold text-gray-900 mb-4">Mật khẩu đã tạo</h3>
